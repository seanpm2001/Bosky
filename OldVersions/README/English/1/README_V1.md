...
![Bosky-Placeholder.png This image failed to load. It may be due to the file not being reached, or a general error. Reload the page to fix a possible general error.](/Bosky-Placeholder.png)

# By:

<!-- ![{Developer name} This image failed to load. It may be due to the file not being reached, or a general error. Reload the page to fix a possible general error.](Image2.svg) !-->

## [Seanpm2001](https://github.com/seanpm2001/), [Bosky-dev](https://github.com/Bosky-dev/) Et; Al.
...
[Sorting options unavailable](https://github.com/Bosky-dev/Bosky)
...
[15.0 - Codename](#Codename)

> [15.1 - When activated](#When-activated)

[16.0 - Setup options](#Setup-options)

[17.0 - Boss detect](#Boss-detect)

[18.0 - Recommendations](#Recommendations)

[19.0 - Programming languages](#Programming-languages)
...
See above. Bosky is a modern day Boss Key software suite that lets you quickly switch from a game back to your work. Extra features include optional, encrypted facial recognition (which deletes automatically after 7 days by default)

You can use 3 keys as the boss key, either `INSERT` `DELETE` or `SUPER` (Known as the Windows key on Windows NT/Windows 9x operating systems)

***

## Wiki

[Click/tap here to view this projects Wiki](https://github.com/Bosky-dev/Bosky/wiki)
...
This project was under consideration since early 2021 October, but wasn't created until 2021 November 9th. It was setup this day, and didn't receive programming work until 2021 November 10th. On 2021 November 10th, the `README.md` file was updated.
...
> * 1. [seanpm2001](https://github.com/seanpm2001/) - 24 commits (As of 2021, Wednesday, November 10th at 5:24 pm)
...
[Project language file B](PROJECT_LANG_2.c)

[Project language file C](PROJECT_LANG_3.py)

[Join the discussion on GitHub](https://github.com/seanpm2001/Bosky/discussions)
...
**File version:** `1 (Wednesday, 2021 November 10th at 5:24 pm)`
...
Version 1 (2021, Wednesday, November 10th at 5:24 pm)
...
> * Added the codename section

> * Added the when activated section

> * Added the setup options section

> * Added the boss detect section

> * Added the recommendations section

> * Added the programming languages section

> * Added the icon section
